(function () {
  ...
  function openMobileHomeMenu() { const menu = document.getElementById('mobileHomeMenu'); const btn = document.getElementById('mobileMenuBtn'); if (!menu || !btn) return; menu.hidden = false; menu.classList.add('is-open'); btn.setAttribute('aria-expanded', 'true'); }
  function closeMobileHomeMenu() { const menu = document.getElementById('mobileHomeMenu'); const btn = document.getElementById('mobileMenuBtn'); if (!menu || !btn) return; menu.classList.remove('is-open'); menu.hidden = true; btn.setAttribute('aria-expanded', 'false'); }
